...
from models.tacotron2 import load_filepaths_and_text
from models.tacotron2.text.symbols import symbols
from models.tacotron2 import text_to_sequence
...
collate = GptTtsCollater(dataset_opt)
dataset = GptTtsDataset(dataset_opt)